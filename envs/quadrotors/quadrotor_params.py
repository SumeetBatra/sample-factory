...
def add_quadrotors_env_args(env, parser):
    ...
    p.add_argument('--team_spirit', default=False, type=str2bool, help='Use team spirit rewards to encourage cooperation. False by default; we dont like teamwork over here :( ')
